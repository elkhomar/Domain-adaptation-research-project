...
from losses import wasserstein, coral, mmd
...
class Trainer:
    ...
    def train(self, source_loader, target_loader, num_epochs, weight_discrepancy, test_loader, dataset, loss_function_str=None, device='cpu', sigma=None):
        """
        ...
        for epoch in range(num_epochs):
            ...
            for (source_data, source_labels), (target_data, _) in zip(source_loader, target_loader):
                ...
                if loss_function_str == 'MMD':
                    discrepancy_loss = mmd(source_features, target_features, sigma)
